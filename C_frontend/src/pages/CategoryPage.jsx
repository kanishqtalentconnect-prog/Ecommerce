        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-serif text-gray-800 mb-4">
              {formatName(formattedCategory)} Idols
            </h1>
            <p className="text-lg text-gray-600 font-light max-w-2xl mx-auto">
              Discover our exquisite collection of handcrafted {formatName(formattedCategory)} brass idols
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="max-w-2xl mx-auto">
              <div className="mb-8">
                ...
                <p className="text-xl text-gray-600 mb-8 font-light leading-relaxed">
                  Our master artisans are carefully crafting exclusive {formatName(formattedCategory)} idol collection. 
                  Each piece will embody divine elegance and spiritual essence.
                </p>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Want to be the first to know when our {formatName(formattedCategory)} idol collection launches? 
              ...
              <div className="grid md:grid-cols-3 gap-6 mt-12">
                <div className="bg-white rounded-xl p-6 shadow-md border border-gray-100">
                  ...
                  <p className="text-gray-600 text-sm">Each idol meticulously crafted by master artisans</p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-md border border-gray-100">
                  <div className="w-12 h-12 bg-amber-100 rounded-full flex items-center justify-center mx-auto mb-4">
                    <span className="text-xl">✨</span>
                  </div>
                  <h4 className="font-semibold text-gray-800 mb-2">Premium Brass</h4>
                  <p className="text-gray-600 text-sm">Finest quality brass with traditional finishing</p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-md border border-gray-100">
                  <div className="w-12 h-12 bg-amber-100 rounded-full flex items-center justify-center mx-auto mb-4">
                    <span className="text-xl">🙏</span>
                  </div>
                  <h4 className="font-semibold text-gray-800 mb-2">Sacred Crafting</h4>
                  <p className="text-gray-600 text-sm">Created with devotion and spiritual reverence</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            <div className="text-center mb-12">
              <p className="text-gray-600 font-light">
                {products.length} exquisite piece{products.length !== 1 ? 's' : ''} in our {formatName(formattedCategory)} collection
              </p>
            </div>
      ...
      <div className="bg-gradient-to-r from-amber-50 to-yellow-50 border-t">
        <div className="max-w-7xl mx-auto px-6 py-16 text-center">
          <h3 className="text-2xl font-serif text-gray-800 mb-4">
            Looking for Custom {formatName(formattedCategory)} Idols?
          </h3>
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            We specialize in creating custom {formatName(formattedCategory)} idols according to your specific requirements and size preferences.
          </p>
          <button 
            onClick={handleContactClick}
