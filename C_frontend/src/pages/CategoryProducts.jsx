        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-serif text-gray-800 mb-4">
              {formatName(formattedCategory)} 
            </h1>
            <p className="text-lg text-gray-600 font-light max-w-2xl mx-auto">
              Discover our exquisite collection of handcrafted {formatName(formattedCategory)} 
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="max-w-2xl mx-auto">
              <div className="mb-8">
                ...
                <p className="text-xl text-gray-600 mb-8 font-light leading-relaxed">
                  Our master artisans are carefully crafting exclusive {formatName(formattedCategory)}  collection. 
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Want to be the first to know when our {formatName(formattedCategory)}  collection launches? 
      ...
      <div className="bg-gradient-to-r from-amber-50 to-yellow-50 border-t">
        <div className="max-w-7xl mx-auto px-6 py-16 text-center">
          <h3 className="text-2xl font-serif text-gray-800 mb-4">
            Looking for Custom {formatName(formattedCategory)} ?
          </h3>
